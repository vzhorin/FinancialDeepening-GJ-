...
function[chi2sq] = gj_xi_disp(hist_file, sim_file, sim_total, out_file)
%clear all;
...
title('Theil Index of Inequality')
axis([1975,1997,0.06,0.12])
...
figure%figAve
%subplot(3,1,1)
plot(t20,Allgrowk(:,(1:TT-1))-1,t20,rg(1:TT-1),'k--')
legend('Stochastic Path','Actual Data',2)
title('GDP Growth')
axis([1975,1997,0,0.15])

%subplot(3,1,2)
%plot(tx,H','k',tx,uf(1:TT),'k-.',tx,rf,'k--')
%title('Participation Rate')
%axis([1975,1997,0.05,0.3])    

%subplot(3,1,3)
figure
plot(tx,Theil(:,1:TT),tx,ut(1:TT),'k-.',tx,rt,'k--')
title('Theil Index')
legend('Stochastic Path','Actual Data',2)
axis([1975,1997,0.06,0.12])
% Save
