function gj_transition(policy_file, hist_file)
...
global  savk faik  kgrid h1 h2 h3 h4 f Faio  m optsav;
...
save(hist_file, 'scale', 'CAPI', 'CONS', 'SAV', 'H', 'T', 'kgrid', 'cgrid', 'sgrid', ....
