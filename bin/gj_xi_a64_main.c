...
extern mclComponentData __MCC_gj_xi_a64_component_data;
 ...
 */
#ifndef LIB_gj_xi_a64_C_API 
#define LIB_gj_xi_a64_C_API /* No special import/export declaration */
#endif

LIB_gj_xi_a64_C_API 
bool MW_CALL_CONV gj_xi_a64InitializeWithHandlers(
...
)
{
  ...
  if (!mclInitializeComponentInstance(&_mcr_inst,
                                      &__MCC_gj_xi_a64_component_data,
...
LIB_gj_xi_a64_C_API 
bool MW_CALL_CONV gj_xi_a64Initialize(void)
{
  return gj_xi_a64InitializeWithHandlers(mclDefaultErrorHandler,
                                         mclDefaultPrintHandler);
}

LIB_gj_xi_a64_C_API 
void MW_CALL_CONV gj_xi_a64Terminate(void)
{
  if (_mcr_inst != NULL)
...
int run_main(int argc, const char **argv)
{
  ...
  __MCC_gj_xi_a64_component_data.path_to_component = path_to_component; 
  if (!gj_xi_a64Initialize()) {
    return -1;
  }
...
int main(int argc, const char **argv)
{
  if (!mclInitializeApplication(
    __MCC_gj_xi_a64_component_data.runtime_options,
    __MCC_gj_xi_a64_component_data.runtime_option_count))
    return 0;
